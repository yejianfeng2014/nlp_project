...
imgname1 = r"./image/20180529111925723.jpg" # 保存的图片名字1(只按照背景图片形状)
imgname2 = r"./image/20180529111925723.jpg"# 保存的图片名字2(颜色按照背景图片颜色布局生成)

my_words_list = ['一夜爆红'] # 在结巴的词库中添加新词

back_coloring = imread(r"./image/20180529111925723.jpg")# 设置背景图片-----back_coloring 为3维数组
